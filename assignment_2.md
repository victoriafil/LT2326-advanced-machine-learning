I run the notebook on Google Colab because I had problems working on the server and because I always got Cuda out of memory errors when training the models there.
